(function() {
  ...
  */
  ...
  tmplSlider = function(o) {
    ...
    slider.find('.slide-pager').append($.map(o.slides, function(slide, o) {
      return $('<a href="javascript:;">' + (o + 1) + '</a>')[0];
    }));
    return slider;
  };
